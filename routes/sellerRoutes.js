...
const Sellerquote = app.put("/seller/quote/:id", isAutharization,autherizesrole('seller'), sellerquote)
const Getallsellerquote = app.get('/get/enquries',isAutharization ,autherizesrole('seller') , getallsellerquote)
